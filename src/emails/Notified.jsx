...
/**
 * WaitlistConfirmationEmail.jsx
 * ---------------------------------------------------------------------------
 * Self-contained. Confirms someone joined the waitlist; no CTA/action
 * required. Footer uses LinkedIn + Instagram (not X), same as the 2FA email.
 * ---------------------------------------------------------------------------
 */
...
export default function WaitlistConfirmationEmail({ recipientName}) {
  return (
    <Html>
      <Head>
      ...
      <Preview>
        Nailed it, {recipientName}. You're officially on the Nexgn waitlist.
      </Preview>
        ...
        <Container style={styles.container} className="container">
          ...
          <Section className="px">
            <Heading
              ...
              className="headline"
            >
              Nailed it, {recipientName}. You&rsquo;re officially on the Nexgn
              waitlist.
            </Heading>
            <Text style={styles.bodyText}>
              We&rsquo;ll hit your inbox the exact millisecond we go live.
              Until then, we promise to keep the annoying updates to zero (we
              save that energy for our Frequent Annoying Questions). Talk
              soon.
            </Text>
          </Section>

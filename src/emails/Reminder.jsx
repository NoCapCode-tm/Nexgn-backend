 ...
 * ---------------------------------------------------------------------------
 * Self-contained — no separate shared file. Informational reminder, no CTA.
 * Footer uses LinkedIn + Instagram, matching TwoFactorEnabledEmail.
 * ---------------------------------------------------------------------------
 */
...
export default function PaymentReminderEmail({
  ...
  return (
    <Html>
      ...
      <Preview>
        {amountDue ? `Payment of ${amountDue} is due` : "Your payment is due"} —
        a quick reminder from Nexgn.
      </Preview>
        ...
        <Container style={styles.container} className="container">
          ...
          <Section className="px">
            ...
            <Text style={styles.bodyText}>
              {recipientName ? `Hi ${recipientName}, this` : "This"} is a
              gentle reminder that your payment
              {amountDue ? ` of ${amountDue}` : ""} is due
              {dueDate ? ` on ${dueDate}` : ""}. Kindly ensure the pending
              amount is settled at the earliest to avoid any interruption in
              services.
            </Text>
            <Text style={{ ...styles.bodyText, marginTop: 6 }}>
              If you have already completed the payment, please disregard
              this notice.
            </Text>
          </Section>

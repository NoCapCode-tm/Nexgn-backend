...
/**
 * TwoFactorEnabledEmail.jsx
 * ---------------------------------------------------------------------------
 * Self-contained — no separate shared file needed. Confirms 2FA was turned
 * on; no CTA/action required. Footer uses LinkedIn + Instagram (not X).
 * ---------------------------------------------------------------------------
 */
...
export default function TwoFactorEnabledEmail({ recipientName = "" }) {
  return (
    <Html>
      <Head>
        <style>{emailHeadCss}</style>
      </Head>
      <Preview>Two-factor authentication is now active on your Nexgn account.</Preview>
        ...
        <Container style={styles.container} className="container">
          ...
          <Section className="px">
            <Heading
              ...
              className="headline"
            >
              {recipientName ? `${recipientName}, your` : "Your"} account has
              successfully activated
              <br />
              Two-Factor Authentication.
            </Heading>
            <Text style={styles.bodyText}>
              This added security measure ensures enhanced protection for
              your login and sensitive information.
            </Text>

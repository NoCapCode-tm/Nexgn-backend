 ...
 * ---------------------------------------------------------------------------
 * Self-contained. Unlike the other templates, Accept/Deny here are real
 * coded buttons (not a flattened image) — text is crisp/selectable in the
 * screenshot, not part of a graphic. Footer uses LinkedIn + Instagram.
 * ---------------------------------------------------------------------------
 */
      ...
      <Body style={{ ...styles.main, fontFamily: BODY_FONT }}>
        <Container style={styles.container} className="container">
          ...
          {/* ---------------- Accept / Deny ---------------- *
              ...
              templates, so this is genuine HTML/CSS. */}
          <Section style={{ marginTop: 24 }} className="px">
            <Row>
              ...
              <Column style={{ verticalAlign: "middle", paddingLeft: 20 }}>
                <Link href={denyUrl} style={styles.denyLink}>
                  Deny
                </Link>
              </Column>
            </Row>
